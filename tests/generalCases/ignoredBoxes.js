...
async function ignoredBoxesSearchGoogle(){
    ...
    let capabilities = {
      ...
      "user": USERNAME,
      "accessKey": KEY,
      name: "SmartUi Ignored Boxes Test", // name of the test
      build: "SmartUi Ignored Boxes Build", // name of the build
